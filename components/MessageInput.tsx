...
function MessageInput({ selectedUser, message, setMesssage, handleMessageSend }: MessageInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-2 border-t border-gray-700 pt-2'>
      ...
      <div className="flex item-center gap-2">
        ...
        className='bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition-colors flex item-center  gap-1 disabled:opacity-50 disables:cursor-not-allowed text-white'
        >
          {
